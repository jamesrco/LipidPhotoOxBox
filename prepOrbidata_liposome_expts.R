# prepOrbidata_liposome_expts.R
#
# Created 4/25/2016 by Jamie Collins, james.r.collins@aya.yale.edu, from parent script created 11/18/2015  
...
#
# LOBSTAHS is under development by the Van Mooy Lab at Woods Hole Oceanographic Institution. Currently, analyzing PAL1314 liposome experiment data.
#
# This script:
#
...
working_dir = "/Users/jrcollins/Code/LipidPhotoOxBox/data/raw/Orbi_MS_data/mzxml/Exp_13/" # specify working directory
...
excluded.mzXMLfiles = c() # c("0475","0474") # specifying removal of Orbi_0475.mzXML and Orbi_0474.mzXML since chromatography was screwy, to the point that weird things started to happen when I used retcor() on them
...
IPO.filesubset = c("2450","2451","2459","2460","2453","2455","2470")
...
saved_IPO_params_centW = "IPO_centWaveparamfits_2016-04-27T5-11-11_PM-0400_neg.csv"
saved_IPO_params_groupretcor = "IPO_retcorGroupparamfits_2016-04-27T9-46-12_PM-0400_neg.csv"
